...
set(LIBYUV_OUTPUT_DIRECTORY ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/libyuv)
ExternalProject_Add(
        libyuv
        ...
        # if(ANDROID)
        SOURCE_DIR ${LIBYUV_OUTPUT_DIRECTORY}
        BUILD_IN_SOURCE 1
        BUILD_BYPRODUCTS ${LIBYUV_OUTPUT_DIRECTORY}/libyuv.a
        # endif()
        LOG_DOWNLOAD ON
        LOG_CONFIGURE ON
        LOG_BUILD ON)
...
elseif(ANDROID)
  set_target_properties(${LIBYUV_LIBRARY} PROPERTIES
          IMPORTED_LOCATION ${LIBYUV_OUTPUT_DIRECTORY}/libyuv.a
          )
else()
  set_target_properties(${LIBYUV_LIBRARY} PROPERTIES
